          ...
          <div className="container">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-center">
              ...
              <div className="flex flex-col justify-center gap-6 sm:pt-0 lg:px-16">
                ...
                >
                  There are many benefits to travelling, both physically and mentally. Travel can help improve your health, increase your knowledge, and allow you to meet new people and experience new cultures. Physical benefits of travel include - getting exercise, being exposed to new environments, and improving your sleep
                  <br />
                </p>
